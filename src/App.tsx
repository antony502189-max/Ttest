...
function RouteTransitionBoundary({ children }: { children: ReactNode }) {
  const location = useLocation()
  return <Suspense key={location.pathname} fallback={<RouteLoading />}>{children}</Suspense>
}
