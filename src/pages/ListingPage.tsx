    ...
    <article className="listing-page idealista-listing-page">
      ...
      <div className="container listing-layout">
        <div className="listing-main">
          ...
          {primaryRestriction ? <section className="listing-restriction-notice" aria-labelledby="restriction-title"><UsersRound aria-hidden="true" /><div><span>Importante antes de contactar</span><h2 id="restriction-title">{primaryRestriction === 'Solo hombre' ? 'Solo para un hombre' : primaryRestriction === 'Solo mujer' ? 'Solo para una mujer' : primaryRestriction}</h2><p>El anunciante ha indicado esta condición para la habitación.</p></div></section> : null}
          <Separator />
