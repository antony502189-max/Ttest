    ...
    <article className="listing-page">
      ...
      <div className="container listing-layout">
        <div className="listing-main">
          ...
          <Separator />
          <section className="listing-section"><h2>Ubicación en el mapa</h2><p className="map-intro">El marcador corresponde a las coordenadas guardadas en el anuncio.</p><div className="detail-map"><MapView items={[listing]} selectedId={listing.id} onSelect={() => undefined} showPreview={false} /></div></section>
          <Separator />
