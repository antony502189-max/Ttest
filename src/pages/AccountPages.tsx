  ...
  return (
    <div className="container account-page saved-searches-page">
      <AccountHeader
        ...
        description="Recibe avisos de habitaciones nuevas sin repetir los mismos filtros."
        action={
          <Button asChild>
            <Link to="/buscar">
      ...
      <div className="saved-searches-layout">
        <section aria-labelledby="saved-searches-title">
          <div className="account-section-head">
            <h2 id="saved-searches-title">Alertas activas</h2>
            <span>
              {t(
          ...
          {savedSearches.length ? (
              ...
              {savedSearches.map((item) => (
                <article key={item.id} className="saved-search-card">
                  ...
                  <div>
                    ...
                    <span>
                      {item.filters.conditions.length
                  ...
                  <div className="saved-search-card__actions">
                    ...
                    <Button
                      ...
                      aria-label={
                        item.alerts
                          ? `Desactivar avisos para ${item.query}`
                          : `Activar avisos para ${item.query}`
                      }
                    >
            ...
            <div className="account-empty saved-search-empty">
              <Bell />
              <h2>Aún no tienes alertas</h2>
              <p>
                Guarda una búsqueda desde los resultados para recibir avisos.
              </p>
              <Button asChild>
  ...
  return (
    <div className="container account-page">
      <AccountHeader
        eyebrow="Tu cuenta"
        title="Perfil"
        description="Controla cómo te ven anunciantes y futuros inquilinos."
        action={
          <Button
      ...
      <div className="profile-layout">
        <aside className="profile-card">
          ...
          <h2>Lucía Martín</h2>
          <p>Busco habitación</p>
          <span className="profile-verified">Identidad básica verificada</span>
        ...
        <form className="profile-form" onSubmit={submit}>
          ...
          <FormField
            ...
            description="Una breve presentación ayuda a iniciar la conversación."
          >
            <Textarea
              id="profile-about"
              defaultValue="Trabajo en remoto y busco una habitación tranquila en el sur de Tenerife. Soy ordenada, no fumo y valoro una convivencia respetuosa."
              disabled={!editing}
              rows={4}
            />
          </FormField>
          <fieldset className="privacy-settings">
            ...
            <label>
              ...
              <Switch aria-label="Mostrar teléfono a anunciantes" defaultChecked disabled={!editing} />
            </label>
            <label>
              <div>
                <strong>Permitir contacto por WhatsApp y Telegram</strong>
                <span>Solo estarán disponibles en anuncios activos</span>
              </div>
              <Switch aria-label="Permitir contacto por WhatsApp y Telegram" defaultChecked disabled={!editing} />
            </label>
          </fieldset>
          {saved ? (
          ...
          <div className="danger-zone">
            ...
            <ConfirmDialog
              ...
              description="Se borrarán favoritos y anuncios. Esta acción no se puede deshacer."
              confirmLabel="Eliminar definitivamente"
              destructive
              onConfirm={() =>
                toast.error("Cuenta marcada para eliminación (demo)")
              }
            />
          </div>
        </form>
...
const demoStatuses: ListingStatus[] = [
  "Publicado",
  "Pendiente",
  "Borrador",
  "Oculto",
...
export function MyListingsPage() {
  const seed = useMemo(
    () =>
      listings
        .slice(0, 6)
        .map((listing, index) => ({ ...listing, status: demoStatuses[index] })),
    [],
  );
  ...
  return (
    <div className="container account-page">
      <AccountHeader
        ...
        title="Mis anuncios"
        description="Gestiona el estado, la vigencia y el rendimiento de tus habitaciones."
        action={
          <Button asChild>
            <Link to="/publicar">
      ...
      {items.length ? (
        <div className="my-listings">
          <div className="listing-summary">
            ...
            <span>
              <strong>4</strong> contactos esta semana
            </span>
          </div>
          {items.map((listing) => (
        ...
        <div className="account-empty">
          ...
          <p>Crea tu primer anuncio y guárdalo como borrador cuando quieras.</p>
          <Button asChild>
