  ...
  return <>
    ...
    {adminAllowed ? <section className="container profile-admin-entry" aria-label="Administración">
      <div>
        ...
        <p>Tu cuenta sigue funcionando como una cuenta normal. Usa este acceso solo cuando necesites moderar la plataforma.</p>
      </div>
      <button type="button" className="profile-admin-entry__button" onClick={() => navigate('/admin')}>
        <LayoutDashboard aria-hidden="true" />
