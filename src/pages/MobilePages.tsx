import { Bell, ChevronRight, CircleHelp, FileText, Heart, Home, Languages, LayoutDashboard, LogOut, MessageCircle, Plus, Search, UserRound } from 'lucide-react'
...
export function MenuPage() {
  ...
  return <section className="mobile-app-page menu-page" aria-labelledby="menu-title">
    ...
    <nav className="app-menu-list" aria-label="Cuenta y anuncios">
      {adminAllowed ? <MenuRow to="/admin" icon={LayoutDashboard}>Administración</MenuRow> : null}
