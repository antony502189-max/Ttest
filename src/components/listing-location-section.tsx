...
const locationCopy = {
  es: {
    mapAria: 'Mapa de la ubicación del anuncio',
    markerTitle: 'Ubicación del anuncio',
    ...
    intro: 'El marcador corresponde a la ubicación guardada en el anuncio.',
  ...
  en: {
    mapAria: 'Map of the listing location',
    markerTitle: 'Listing location',
    mapUnavailable: 'Map unavailable',
    actionsAria: 'Location actions',
    directions: 'Get directions',
    streetView: 'Street View',
    heading: 'Location on the map',
    intro: 'The marker matches the location saved in the listing.',
  ...
  ru: {
    mapAria: 'Карта местоположения объявления',
    markerTitle: 'Местоположение объявления',
    ...
    intro: 'Метка соответствует местоположению, сохранённому в объявлении.',
